...
for entry in entries_needing_predictions:
    ...
    # Only proceed if there's a single label in the ground truth
    if len(set(ground_truth_emotions)) == 1:
        ...
        if predicted_distribution:
            ...
            y_true.append(normalize_emotion_name(ground_truth_emotions[0]))
            y_pred.append(highest_pred_emotion)

            # Print results
            print(f"Audio ID: {audio_id}")
            print(f"Ground Truth Emotion: {ground_truth_emotions[0]}")
